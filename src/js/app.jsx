        ...
        return <div className="container" style={{background: 'white'}}>
                    {!this.props.list? null :
                        this.props.list.map((el, i) =>
                            <div key={i} style={{fontFamily: "Arial, Helvetica, sans-serif"}}>
                                <PopUp img={<img src={el.pictures}
                                                 alt="pic"
                                                 height='250px'
                                                 width='250px'
                                                 style={{borderRadius: '10px'}}></img>}
                                                 attraction={this.props.list[i]} />
                                <PopUp h3={<h3 style={{color: 'grey'}}>{el.name}</h3>}
                                       attraction={this.props.list[i]} /> <br/>
                                ...
                                <PopUp link={<a href="">...czytaj wiecej</a>}
                                       attraction={this.props.list[i]} /> <br/>
